...
const subscriptionSchema = z.object({
    ...
    subscriptionType: z.object({
        subscriptionTypeBasic: z.number().min(0).default(0),
        subscriptionTypePro: z.number().min(0).default(0)
    }).optional(),
    billingType: z.enum(['Monthly', 'Yearly']),
    discount: z.number().min(0, 'Discount cannot be negative').default(0).optional(),
